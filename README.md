...
| 版本 | versionCode | 内容 |
|------|------------|------|
| **5.1.8** | 5108 | 待办看板去掉归属笔记名；事项字号 14 |
...
| **5.1.2** | 5102 | 介绍页 hero 落点放大到 120dp |
| **5.1.1** | 5101 | 介绍页 hero 矢量克隆（放大清晰），落点外接盒统一 |
| **5.1.0** | 5100 | Tab 介绍页 hero 单图标直飞（落点零闪烁）；介绍文案说明书化 |
| **5.0.58** | 558 | Tab 介绍页（点顶栏图标看功能说明，不切 Tab）；终端介绍页顶部含系统信息与存储饼图；设置页移除系统信息入口 |
